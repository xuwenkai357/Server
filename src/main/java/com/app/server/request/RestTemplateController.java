...
public class RestTemplateController {
    ...
    public BookinfoResponse getBookInfo(String url,String isbn){
        System.out.println(url+"?q="+isbn+"&fields=id");

        BookinfoResponse bookinfoResponse  = restTemplate.getForObject(url+"?q="+isbn+"&fields=id,title,author,publisher,pubdate,summary,image,pages,price,isbn13",BookinfoResponse.class);
